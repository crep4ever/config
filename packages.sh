...
#Dev
sudo apt-get install $FLAGS awesome build-essential emacs git-core qgit libmagick++-dev perl python subversion cmake valgrind qt4-dev-tools libqt4-sql-sqlite libqt4-declarative libxml++2.6-dev libarchive-dev ruby rubygems doxygen;
