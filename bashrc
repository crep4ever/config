...
alias clean='find -O3 . -name "*~" -or -name "*.bak" -or -name "#*#" -or -name "Thumbs.db" -or -name "desktop.ini" -print0 | xargs -0 rm -rf' 
alias c='clear'
alias maek='make'
alias amke='make'
alias dc='cd'
alias rmsvn='find . -name ".svn" -type d -print0 | xargs -0 rm -rf'
